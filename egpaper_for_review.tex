...
%%%%%%%%% TITLE
\title{\LaTeX\ Author Guidelines for ACPR Proceedings}
...
Please refer to the author guidelines on the acpr 2015 web page for a
discussion of the policy on dual submissions.

\subsection{Paper length}
For acpr 2015, the rules about paper length have changed, so please
...
the \verb'\acprfinalcopy' command in the document preamble.)  Reviewers:
...
and you believe that the acpr70 audience would like to hear about your
...
Please refer to the author guidelines on the acpr 2015 web page for a discussion
